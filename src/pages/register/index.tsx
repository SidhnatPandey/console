        ...
        >
          <Box sx={{ width: '100%', maxWidth: 400 }}>
            ...
            <Box sx={{ my: 1.5 }}>
              ...
              <Typography sx={{ color: 'text.secondary' }}>Make your app management easy and secure!</Typography>
            </Box>
            <form noValidate autoComplete='off' onSubmit={e => e.preventDefault()}>
              ...
              />
              <CustomTextField fullWidth label='Organization' placeholder='Initializ Inc.' />
              <FormControlLabel
                control={<Checkbox />}
