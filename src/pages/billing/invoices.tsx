...
import { Box, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, TableSortLabel, TablePagination, Typography, Divider } from '@mui/material';
            ...
            <TableBody>
              {sortedRows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row,index) => (
                <TableRow key={index+1}>
                  ...
                  <a href={`data:application/pdf;base64,${row.pdf}`} download="document.pdf">Download</a>
